							...
							<div class="row latest-news blog-v1">
								<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						...
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/4.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        							<a href="blog-details.jsp">New Chicago school budget </a>
		        							<p>Education is the process of facilitating learning. Knowledge kills, values, beliefs, and habits of a group of people are transferred </p>
		        						</div> <!-- /.text -->
		        					</div> <!-- /.text-wrapper -->
		        				</div> <!-- /.single-post -->
		        				...
		        				<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						<div class="date wow fadeInUp p-color-bg">12 <span>Sep</span></div>
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/5.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        				...
		        				<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						<div class="date wow fadeInUp p-color-bg">12 <span>Sep</span></div>
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/6.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        				...
		        				<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						<div class="date wow fadeInUp p-color-bg">12 <span>Sep</span></div>
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/8.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        				...
		        				<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						<div class="date wow fadeInUp p-color-bg">12 <span>Sep</span></div>
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/9.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        				...
		        				<div class="single-post wow fadeInUp col-lg-6 col-md-6 col-sm-6 col-xs-6">
		        					<div class="img-holder">
		        						<div class="date wow fadeInUp p-color-bg">12 <span>Sep</span></div>
		        						<img src="<%=request.getContextPath()%>/resources/images/blog/11.jpg" alt="Image">
		        						<a href="blog-details.jsp" class="tran4s"></a>
		        					</div>
		        					<div class="text-wrapper">
		        						<div class="text tran4s">
		        				...
		        				<div class="wrapper-left">
		        					...
		        					<div class="sidebar-box quick-event-list">
		        						<div class="box-wrapper">
		        							...
		        							<ul>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> CORPORATE EVENT</a></li>
		        								<li class="active"><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> ECONOMIC EVENT</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> LAW AND ECONOMICS</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> THE SECRETS OF ECONOMIC</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> CONTENT STRATEGY</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> IT & SOFTWARE</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> TEXT STRATEGY</a></li>
		        								<li><a href="event-details.jsp" class="tran3s"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Finance rss</a></li>
		        							</ul>
		        						</div> <!-- /.box-wrapper -->
		        							...
		        							<div id="talent-teacher-carousel" class="carousel slide" data-ride="carousel">
												  ...
												  <div class="carousel-inner" role="listbox">
												    <div class="item active">
												      <img src="<%=request.getContextPath()%>/resources/images/inner-page/16.jpg" alt="Teacher">
												      <h6>Mahfuz Riad</h6>
												      ...
												      <ul class="organize-list">
														...
														<a href="teacher-profile.jsp" class="theme-bg-color view-profile tran3s">View Profile</a>
												    </div> <!-- /.item -->
		        						...
		        						<div class="box-wrapper">
		        							...
		        							<div class="single-event clear-fix">
		        								...
		        								<div class="post float-left">
		        									<a href="course-details.jsp" class="tran3s">Overviewing the leading contemporary conceptions</a>
		        									<ul>
		        					...
		        					<div class="sidebar-box feature-event">
		        						<div class="box-wrapper">
		        							...
		        							<div class="single-event clear-fix">
		        								...
		        								<div class="post float-left">
		        									<a href="event-details.jsp" class="tran3s">The multi-group recital included jolly</a>
		        									<ul>
