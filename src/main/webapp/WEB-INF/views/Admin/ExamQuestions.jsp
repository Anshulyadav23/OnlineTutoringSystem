        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="form-group">
                      ...
                      <form action="${pageContext.request.contextPath}/Admin/getExamQuestionTable" method="post">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <c:forEach var="data" items="${quizs }" varStatus="status">
                                      <tr class="odd gradeX">
                                        <td>${status.index+1 }</td>
                                        <td class="center">${data.getQuestion() } </td>                                        
                                        <td>${data.getChoice() }</td>
                                        <td>${data.getAnswer() }</td>
                                        <td class="center">
                                        <form action="${pageContext.request.contextPath}/Admin/deleteQuestion/${data.getID() }" method="post">
                                            <input  type="submit" name="deleteexam" value="Delete Question">
                                        </form>
                                        </td>
                                        <td class="center">
                                        <form action="${pageContext.request.contextPath}/Admin/updateQuestion/${data.getID() }" method="post">
                                            <input  type="submit" name="deleteexam" value="Update Question">
                                        </form>
                                        </td>
                                         </tr>
